...
import 'package:digi_vegetable/ui/profile/helper/address/address.dart';
import 'package:digi_vegetable/ui/profile/helper/edit_profile/edit_profile.dart';
import 'package:digi_vegetable/ui/profile/helper/help_center/help_center.dart';
import 'package:digi_vegetable/ui/profile/helper/privacy_policy/privacy_policy.dart';
import 'package:digi_vegetable/ui/profile/helper/profile_notification/profile_notification.dart';
  ...
  static Route onGenerateRoutes(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case AppRoute.filter:
        return PageTransition(
            child: Filter(isFromSearch: isFromSearch),
            type: PageTransitionType.fade,
            duration: const Duration(milliseconds: 300));
      ...
      case AppRoute.profileNotification:
        return PageTransition(
            child: const ProfileNotification(),
            type: PageTransitionType.fade,
            duration: const Duration(milliseconds: 300));
