    ...
    return Consumer(builder: (context, ref, child) {
      ...
      return Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: CommonButton(onTap: (){}, btnText: "Skip",border: Border.all(color: AppColors.primary,width: 1.5),backgroundColor: AppColors.white,txtColor: AppColors.primary,)),
              SizedBox(width: 4.w,),
