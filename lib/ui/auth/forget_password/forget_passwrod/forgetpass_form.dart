    ...
    return Consumer(builder: (context, ref, child) {
      ...
      return Form(
        ...
        child: Column(
          ...
          children: [
            Text(appStringWatch.passwordRecoveryKey,style: TextStyles.w600.copyWith(fontSize: 20.sp,color: AppColors.black),),
            Text(appStringWatch.recoveryPassSubtitle,style: TextStyles.w600.copyWith(fontSize: 14.sp,color: AppColors.textGreyColor),),
            ...
            }, btnText: appStringWatch.nextKey),
